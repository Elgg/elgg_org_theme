...
#top_left {
	...
	margin-right: 30px;
	padding: 5px 10px;
	background: url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_spotlight_image.gif) no-repeat right center;
}
...
#top_left .homepage_join_link {
	...
	width: 213px;
	height: 37px;
	background: url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_join.gif) no-repeat left top;
}
#top_left .homepage_join_link:hover {
	background: url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_join_over.gif) no-repeat left top;
}
...
.elgg-module-community-plugins {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_plugins.gif) no-repeat bottom center;
	margin-left: 0;
}

.elgg-module-community-discussion {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_groups.gif) no-repeat bottom center;
}

.elgg-module-community-more {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_box.gif) no-repeat bottom center;
	margin-right: 0;
}
...
.elgg-module-community-more .bug_tracker {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_bullet_bug_tracker.gif) no-repeat left top;
}
.elgg-module-community-more .mailing_list {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_bullet_mailing_list.gif) no-repeat left top;
}
.elgg-module-community-more .api_reference {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_bullet_api_reference.gif) no-repeat left top;
}
.elgg-module-community-more .chat {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_bullet_chat.gif) no-repeat left top;
}
...
.homepage_more_link {
	...
	height: 22px;
	text-indent: 9999em;
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_more.gif) no-repeat left top;
}

.homepage_more_link:hover {
	background:url(<?php echo $vars['url']; ?>mod/elgg_org_theme/graphics/homepage_more_over.gif) no-repeat left top;
}
